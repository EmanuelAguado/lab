...
This repository is dedicated to research and development of addons for **Ayon**, focused on studio and production environments.

It contains experimental implementations, prototypes, and utilities aimed at extending and evaluating Ayon’s capabilities in real production pipelines, with a focus on integration, workflow optimization, and pipeline automation in studio contexts.

The development is currently being evaluated in a production-like environment combining **Ayon + Kitsu**, in order to test interoperability, task tracking, and production workflow integration under realistic conditions.
